const elements = {
    nodes: [
        ...
        { data: { id: '343', title: 'Databases', dependencies: 0, info: true, description: "Study of theory and application of database management systems. Topics include database design, data normalization, transaction management and data access methods. Prerequisite: grade of C or higher in CSCI 202. Fall." } },
        ...
        { data: { id: '412', title: 'Computer Vision', dependencies: 0, description: "A study of inference from noisy and uncertain data using probabilistic, statistical, data-driven approaches. Topics include image processing; segmentation, grouping, and boundary detection; recognition and detection; motion estimation and structure from motion. Prerequisites: grade of C or higher in CSCI 202; STAT 185 or 225. Even years Fall." } },
        { data: { id: '434', title: 'Theory of Computation', dependencies: 1, systems: true, description: "A study of formal models of computation, grammars and languages, including finite state machines, regular expressions and Turing machines. Prerequisites: a grade of C or higher in CSCI 202; MATH 251. Fall." } },
        { data: { id: '431', title: 'Programming Languages', dependencies: 0, description: "Definition and design of high-level programming languages; formal tools for language definition and specification of semantics; case studies of several languages. Prerequisite: CSCI 434. Even years Spring." } },
