export default {
    nodes: [
        ...
        {
            data: { id: 'MATH191', parent: 'EXTERNAL', title: 'Calculus I', dependencies: 0, info: true, systems: true },
            position: { x: -75, y: 565 }
        },
        {
            data: { id: 'MATH251', parent: 'EXTERNAL', title: 'Discrete Mathematics', dependencies: 0, info: true, systems: true },
            position: { x: -75, y: 500 }
        },
        {
            data: { id: 'STAT185', parent: 'STAT', title: 'Introductory Statistics', dependencies: 0, info: true, systems: true },
            position: { x: -150, y: 500 }
        },
        {
            data: { id: 'STAT225', parent: 'STAT', title: 'Introduction to Calculus-Based Statistics', dependencies: 0, info: true, systems: true },
            position: { x: -200, y: 500 }
        },
        {
            data: { id: 'PHYS221', parent: 'EXTERNAL', title: 'Physics I', dependencies: 2, systems: true },
            position: { x: 25, y: 565 }
        },
        {
            data: { id: 'PHYS222', parent: 'PHYS', title: 'Physics II', dependencies: 0, systems: true },
            position: { x: 0, y: 500 }
        },
        {
            data: { id: 'PHYS231', parent: 'PHYS', title: 'Introductory Physics II', dependencies: 0, systems: true },
            position: { x: 50, y: 500 }
        },
        {
    ...
    edges: [
        ...
        { data: { source: 'MATH251', target: 'MATH191' } },
        { data: { source: 'PHYS222', target: 'PHYS221' } },
        { data: { source: 'PHYS231', target: 'PHYS221' } }
    ]
};