...
//         { data: { id: 'MATH 191', parent: 'MATHSYSTEMS', title: 'Calculus I', dependencies: 0, info: true, systems: true }},
//         { data: { id: 'MATH 251', parent: 'MATHSYSTEMS', title: 'Discrete Mathematics', dependencies: 0, info: true, systems: true }},
...
//         { data: { id: 'MATH 192', title: 'Calculus II', parent: 'MATHSYSTEMS', dependencies: 0, systems: true}},
//         { data: { id: 'MATH 291', title: 'Calculus III', parent: 'MATHSYSTEMS', dependencies: 0, systems: true}},
//         { data: { id: 'MATH 365', title: 'Linear Algebra I', parent: 'MATHSYSTEMS', dependencies: 0, systems: true}},
//         { data: { id: 'MATH 441', title: 'Numerical Analysis (CSCI 441)', parent: 'MATHSYSTEMS', dependencies: 0, systems: true}},
//         { data: { id: 'MATHSYSTEMS', is_group: true, group_label: 'At Least 8 Credit Hours', title: 'At Least 8 Credit Hours', parent: 'EXTERNAL', systems: true}},
//         { data: { id: 'EXTERNAL', is_group: true, group_label: 'Math & Physics Requirements', title: 'Math & Physics Requirements', dependencies: 0, systems: true, info: true }},
//         { data: { id: 'CSCI 18X', is_group: true, title: 'Introductory Programming (Either 182 or 183 or 185)', dependencies: 3, minor: true, info: true, systems: true } },
//         { data: { id: 'STAT', is_group: true, parent: 'MATHSYSTEMS', title: 'Statistics Requirement', dependencies: 0, info: true, systems: true }},
//         { data: { id: 'PHYS', is_group: true, parent: 'EXTERNAL', group_label: 'Pick One', title: 'Physics Requirements', dependencies: 0, systems: true }},
//     ],
//     edges: [
